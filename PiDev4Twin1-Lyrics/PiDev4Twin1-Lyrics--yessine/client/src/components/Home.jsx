        ...
        <div className="container">
          <div className="row justify-content-center">
            ...
            {/* <div className="buttons d-flex justify-content-center">
                            <a to="/contact" className="btn btn-light me-4 rounded-pill px-4 py-2">Login</a>
                            <a to="/service" className="btn btn-outline-light rounded-pill px-4 py-2">Register</a>
                        </div> */}
          </div>
        </div>
      </section>
