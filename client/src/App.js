    ...
    <>
      <AuthProvider>
        ...
        <Routes>
          ...
          <Route exact path="/Payement" element={<Payement cartItems={reservedVoyages} />} />


          <Route path="/Success" element={<Success cartItems={reservedVoyages} />}/>
          <Route path="/Cancel" element={<Cancel  cartItems={reservedVoyages}/>}/>
        </Routes>
<Chat/>
        <Footer />
      </AuthProvider>
